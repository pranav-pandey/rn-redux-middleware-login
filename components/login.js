...
import {login_server} from './../actions/index';
...
function mapDispatchToProps(dispatch){
	...
	return { login : (usercred) => {  dispatch(loginAsync(usercred)) }, change_text : (text) => { dispatch(change_text(text))},change_password : (passtext) => {dispatch(change_password(passtext))}
	}
}
...
class Login extends Component{
	...
	onButtonPress(){
    //console.log('button prese');
		 this.props.login({
		     email : this.props.text,
